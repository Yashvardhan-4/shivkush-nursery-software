...
export default function NotebookPage() {
  ...
  if (!role) {
    return <div className="p-10 text-center text-gray-500 font-bold">{t('loadingLedger')}</div>;
  }

  return (
    <div className="p-6 mb-24">
      <header className="mb-6">
        <h1 className="text-3xl font-extrabold text-gray-900">{t('digitalLedger')}</h1>
