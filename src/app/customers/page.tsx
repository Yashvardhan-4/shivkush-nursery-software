    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gray-50 p-6">
        <div className="bg-white rounded-3xl shadow-sm border border-red-100 p-10 text-center max-w-sm w-full">
          ...
          <p className="text-gray-500 font-medium">Only the owner can view the customer ledger.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="p-6 mb-20 space-y-6">
      <header className="mb-2">
        ...
        <p className="text-sm font-medium text-gray-500 mt-1">Full customer ledger & history</p>
      </header>
      <CustomerLedger />
    </div>
  );
